...
public class TestVector {
	public static void main(String args[]) {
		...
		while(iter.hasNext()) {
			...
			List<Employee> empArr= new Vector<Employee>();
			...
			System.out.println("Demonstration of Object values");
			List<Employee> empArr1= new Vector<Employee>();
			...
			List<Employee> empArr2= new Vector<Employee>();
			...
			List<Integer> arr1= new Vector<Integer>();
			arr1.add(10);
			arr1.add(20);
			arr1.add(30);
			arr1.add(40);

			List<Integer> arr2= new Vector<Integer>();
			arr2.add(20);
			arr2.add(50);
			arr2.add(10);
			arr2.add(30);
